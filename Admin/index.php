...
<body>
  <div class="container-scroller">
    ...
    <div style="background-color: whitesmoke;" class="container-fluid page-body-wrapper">
      ...
      <div class="dak">
          <div class="bruh">
          <h2 style="font-size: 30px; padding-bottom: 20px; text-align: center; font-family: 'Noto Sans', sans-serif;">Welcome home, Admin ! </h2>
            <h3><a href="?ym=<?php echo $prev; ?>"><i class='fas fa-caret-square-left' style='font-size:24px'></i></a> <?php echo $html_title; ?> <a href="?ym=<?php echo $next; ?>"><i class='fas fa-caret-square-right' style='font-size:24px'></i></a></h3>
              <table background="images/ayaka_art_2.jpg" class="table table-border-danger">
                  <tr>
                      <th>Sun</th>
                      <th>Mon</th>
                      <th>Tue</th>
