...
<div class="container">
    <div class="row">
        <div class="">
            ...
            <div class="col-md-8">
                <h1 id="tieude">Thêm câu hỏi Listening </h1>
                    ...
                    <div class="form-group">
                        <div style="height: 100%;" class="form-control" >
                            <div style="padding-bottom: 5px; border-bottom: 1px solid grey;" class="">
                                ...
                                <input type="text" name="mapart" id="mapart" value="L1" readonly>
                            </div>
                            ...
                            <div style="padding-bottom: 5px; padding-top: 10px; border-bottom: 1px solid grey;" class="">
                                <p style="font-weight: bold;">Tải File lên:</p> <input type="file" name="image" id="image" accept=".jpg, .jpeg, .png">
                            </div>
