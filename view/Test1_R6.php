...
<head>
    ...
    <title>ATI | Test Reading 6</title>
    <style>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="" method="post">
                    <h2 style="text-align: center; margin: 10px;">PART 6: TEXT COMPLETION</h2></br>
                    <?php
                    ...
                    <?php
                        if(isset($_POST['gui']))
                        {
                            ...
                            {  
                                ...
                                echo '<script>window.location.href="R6.php"</script>';
                            }
                            else
                            {
