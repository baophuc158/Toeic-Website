<?php
    ...
    else
    {
        ...
        $hien=$p->xuatDV_L4();
?>
    <title>ATI | Test Listening 4</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="" method="post">
                    <h2 style="text-align: center; margin: 10px;">PART 4: SHORT TALKS</h2>
                    <?php
                    ...
                    ?>      <div style="height: 100%; background-color: azure;" class="form-control">
                                ...
                                <?php while($cot=mysqli_fetch_assoc($xuat)){
                                    ?>
                                ...
                                ?>
                                    <?php
                                        $hienthi = $p->xuat_script_L4($row['MaDV']);
                                        while($hang = mysqli_fetch_assoc($hienthi))
                                        {
                                            $id = 'modal-' . $hang['MaDV']; // Tạo ID modal duy nhất
                                            $madv = $hang['MaDV'];
                                            $script = $hang['script'];
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                    <script>
                                                        document.body.style.setProperty('padding-right', 'initial');
                                                    </script>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary my-button" data-toggle="modal" data-target="#<?php echo $id; ?>" data-id="<?php echo $madv; ?>">
                                        Show script
                                    </button>
                            </div><br>
                    <?php
                    ...
                    <?php
                        if(isset($_POST['gui']))
                        {
                            ...
                            {  
                                ...
                                echo '<script>window.location.href="L4.php"</script>';
                            }
                            else
                            {
