...
<head>
    ...
    <title>ATI | Test Listening 2</title>
</head>
<body>
    <div class="container">
        <!--------------------------------------->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form action="" method="post">
                    <h2 style="text-align: center; margin: 10px;">PART 2: QUESTION-RESPONSE</h2>
                    <?php
                    $batdau = 0;
                    ...
                    ?>      <div style="height: 100%; background-color: azure;" class="form-control">
                                ...
                                <i class="fa-solid fa-headset"><h4 style="font-weight: bold;"><?php echo 'Question'.' '. $count++.':'; ?></h4></i>
                                ...
                                <button id="hien_thi_<?php echo $batdau; ?>" class="hien_thi my-button" >Show/Hide Script</button>
                                <div id="myAnswer_<?php echo $batdau; ?>" class="myAnswer">
